 ...
 */
function templatedtheory_custom_colors_css() {
	 ...
	 */
	$saturation = absint( apply_filters( 'templatedtheory_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.templatedtheory-front-page) .entry-title,
...
.colors-custom .templatedtheory-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.templatedtheory-front-page .panel-content .recent-posts article,
...
.colors-custom.templatedtheory-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'templatedtheory_custom_colors_css', $css, $hue, $saturation );
}
